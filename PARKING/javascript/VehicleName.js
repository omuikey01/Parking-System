document.getElementById("Vehiname").addEventListener("blur", VWith)

function VWith() {
    async function dataWith() {
        let tonum = parseInt(prompt("Enter Token Number", "0000"));
        let Name = document.getElementById("Vehiname").value;
        let url = `http://localhost:3000/PARK?vname=${Name}`;
        ...
        myTab += "</table>";
        document.getElementById("showName").innerHTML = myTab;
    }
    dataWith();
}
